...
#if 1 /* V54_BSP */
COMPATIBLE_IOCTL(SIOCGIFLIST)
#endif
COMPATIBLE_IOCTL(SIOCSIFENCAP)
COMPATIBLE_IOCTL(SIOCGIFENCAP)
COMPATIBLE_IOCTL(SIOCSIFNAME)
#if 1 /* V54_BSP */
COMPATIBLE_IOCTL(SIOCSIFSTAINFOEXTRACT)
COMPATIBLE_IOCTL(SIOCSIFOPT82)
#endif
...
#if 1 /* V54_BSP, CONFIG_ETYPE_DEVICE */
COMPATIBLE_IOCTL(SIOCGETYPEDEV)
COMPATIBLE_IOCTL(SIOCSETYPEDEV)
COMPATIBLE_IOCTL(SIOCGDOT1X)
COMPATIBLE_IOCTL(SIOCSDOT1X)
#endif
#if 1 /* V54 */
COMPATIBLE_IOCTL(SIOCGPOLICY)
COMPATIBLE_IOCTL(SIOCSPOLICY)
#endif
