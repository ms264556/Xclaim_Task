...
#else
    printk("Tx ring: head=%d, tail=%d, nelem=%d\n",         \
           mac->mac_txring.ring_head,                       \
           mac->mac_txring.ring_tail,                       \
           mac->mac_txring.ring_nelem);                     \
    printk("Rx ring: head=%d, tail=%d, nelem=%d\n",         \
           mac->mac_rxring.ring_head,                       \
           mac->mac_rxring.ring_tail,                       \
           mac->mac_rxring.ring_nelem);                     \
#endif
    spin_unlock_irqrestore(&mac->mac_lock, flags);          \
}while(0);
