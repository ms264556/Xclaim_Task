...
#define ATHR_MAC_TASK_SGMII()                   \
        athr_gmac_t *mac = (athr_gmac_t *)      \
        container_of(ws, athr_gmac_t, mac_sgmii_intr)
#endif
...
#if defined (CONFIG_MACH_QCA955x) || defined (CONFIG_MACH_QCA955x_MODULE)
#define ATHR_MAC_INIT_SGMII_INT(m, f)   INIT_WORK(&m->mac_sgmii_intr, (void *)f)
#else 
#define ATHR_MAC_INIT_SGMII_INT(m, f)  /* Do nothing */
#endif
