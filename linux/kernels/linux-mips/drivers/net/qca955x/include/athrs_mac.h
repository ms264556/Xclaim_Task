...
#if defined(CONFIG_MACH_QCA955x) || defined(CONFIG_MACH_QCA955x_MODULE) || defined(CONFIG_MACH_QCA953x)
...
#if (defined (CONFIG_MACH_QCA955x) || defined (CONFIG_MACH_QCA955x_MODULE)) && defined(CONFIG_ATHRS17_HNAT)
