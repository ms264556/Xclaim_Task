...
#if defined(V54_BSP)
#define ATHR_GMAC_PHY_RD                  ((ATHR_GMAC_CTRL_IOC << 16) | 0x10)                   /* GMAC PHY READ */
#define ATHR_GMAC_PHY_WR                  ((ATHR_GMAC_CTRL_IOC << 16) | 0x11)                   /* GMAC PHY WRITE */
#define ATHR_GMAC_PHY_FORCE               ((ATHR_GMAC_CTRL_IOC << 16) | 0x12)                   /* GMAC PHY FORCE */
#endif
