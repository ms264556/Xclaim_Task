...
#if 1	/* CONFIG_AP43 */
/* for GD4 */
#define AR5315_GPIO_DI  AR531X_GPIO_DI
#define AR5315_GPIO_DO  AR531X_GPIO_DO
#define AR5315_GPIO_CR  AR531X_GPIO_CR
...
#define AR5315_SW1_GPIO         6
#define AR5315_SW2_GPIO         8
#define AR5315_NUM_GPIO         23

#ifdef CONFIG_MTD_SPI_FAST_WRITE
#define FAST_WRITE_256 1
#else
#undef FAST_WRITE_256
#endif

#define _FAST_WRITE_TEST 0
#if _FAST_WRITE_TEST
#define AR5315_FAST_WRITE_GPIO  10
#else
#define AR5315_FAST_WRITE_GPIO  3
#endif
...
#if DRAM_MB == 32
#define AR5315_SDRAM_COL_WIDTH      9
#define AR5315_SDRAM_ROW_WIDTH      13
#elif DRAM_MB == 16
#define AR5315_SDRAM_COL_WIDTH      9
