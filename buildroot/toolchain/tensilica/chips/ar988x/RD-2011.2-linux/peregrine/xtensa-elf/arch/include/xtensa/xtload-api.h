/* Customer ID=8327; Build=0x3b95c; Copyright (c) 2003-2010 Tensilica Inc.  ALL RIGHTS RESERVED.
...
void xtload_reset_and_stall (core_number_t core);
void xtload_ignore_and_continue (core_number_t core);
...
void xtload_read_words (xtload_address_t addr, xtload_word_count_t size);
...
void xtload_read_register (int core);
