/*  Customer ID=8327; Build=0x3b95c; Copyright (C) 2007--2009 Tensilica, Inc. */
...
/* TENSILICA: The definition of _IO_cookie_io_functions_t clashes with the
   version in uClibc for Linux.  Since it does not appear to be used for
   for libstdc++, just comment it out for uClibc.  */
#ifndef __UCLIBC__
