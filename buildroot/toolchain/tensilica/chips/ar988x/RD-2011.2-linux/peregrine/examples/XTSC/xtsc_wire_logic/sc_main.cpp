...
int sc_main(int argc, char *argv[]) {
  ...
  try {
    ...
    logic->connect(*source, "A", "A");

    // Connect source to logic
    logic->connect(*source, "B", "B");

    // Connect logic to not_A
    not_A->connect(*logic, "not_A");

    // Connect logic to A_and_B
    A_and_B->connect(*logic, "A_and_B");

    // Connect logic to A_or_B
    A_or_B->connect(*logic, "A_or_B");

    // Connect logic to A_xor_B
    A_xor_B->connect(*logic, "A_xor_B");
    ...
    A_dup1->connect(*logic, "A_dup1");

    // Connect logic to A_dup2
    A_dup2->connect(*logic, "A_dup2");

    // Connect logic to A_B
    A_B->connect(*logic, "A_B");
