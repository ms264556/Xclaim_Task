...
volatile xtsc_dma_request    *req  = (xtsc_dma_request*)    0xC0001000;
volatile xtsc_dma_descriptor *desc = (xtsc_dma_descriptor*) 0xC0001100;

// Source data physical address (not virtual)
u32 source_addr = 0xC0002000;



void interrupt_handler(int num) {
  // Clear level-triggered interrupt
  volatile u32 *clear_interrupt = (u32 *) 0xC0000000;
  *clear_interrupt = 0;
  dma_done = 1;
}
...
void program_dma(u32 source_address8, u32 destination_address8, u32 size8) {
  ...
  req->notify_address8          = 0xC0000000;
