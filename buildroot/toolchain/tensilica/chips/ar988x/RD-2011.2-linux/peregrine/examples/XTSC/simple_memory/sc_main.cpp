...
int sc_main(int argc, char *argv[]) {
  ...
  try {
    ...
    if (test_using_master) {
      ...
      simple_memory_parms memory_parms(4, 0x00400000, 0x60000000);
      ...
      simple_memory_parms rom_parms(4, 0x00020000, 0x40000000);
      rom_parms.extract_parms(argc, argv, "rom");
      simple_memory rom("rom", rom_parms);

      // Create System RAM using simple_memory
      simple_memory_parms ram_parms(4, 0x00400000, 0x60000000);
