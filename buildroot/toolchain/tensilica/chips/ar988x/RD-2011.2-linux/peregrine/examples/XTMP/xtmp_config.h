/*
 * Customer ID=8327; Build=0x3b95c; Copyright (c) 2003-2007 by Tensilica Inc.  ALL RIGHTS RESERVED.
 *
...
#define XTMP_CONFIG_NAME		"peregrine"
...
#define XTMP_SYS_ROM_PADDR		0x40000000
#define XTMP_SYS_ROM_VADDR		0x40000000
#define XTMP_SYS_ROM_SIZE		0x00020000

#define XTMP_HAS_SYS_RAM		1
#define XTMP_SYS_RAM_PADDR		0x60000000
#define XTMP_SYS_RAM_VADDR		0x60000000
#define XTMP_SYS_RAM_SIZE		0x00400000
...
#define XTMP_DATA_RAM0_PADDR		0x00400000
#define XTMP_DATA_RAM0_VADDR		0x00400000
#define XTMP_DATA_RAM0_SIZE		0x00040000
#define XTMP_DATA_RAM0_BUSY		0
#define XTMP_DATA_RAM0_INBOUND		1
#define XTMP_DATA_RAM1_PADDR		0x00440000
#define XTMP_DATA_RAM1_VADDR		0x00440000
#define XTMP_DATA_RAM1_SIZE		0x00040000
#define XTMP_DATA_RAM1_BUSY		0
...
#define XTMP_INST_RAM0_PADDR		0x00900000
#define XTMP_INST_RAM0_VADDR		0x00900000
#define XTMP_INST_RAM0_SIZE		0x00080000
#define XTMP_INST_RAM0_BUSY		0
#define XTMP_INST_RAM0_INBOUND		1
#define XTMP_INST_RAM1_PADDR		0x00980000
#define XTMP_INST_RAM1_VADDR		0x00980000
#define XTMP_INST_RAM1_SIZE		0x00080000
#define XTMP_INST_RAM1_BUSY		0
...
#define XTMP_RESET_VECTOR_VADDR		0x0097F000

#define XTMP_NUM_INTERRUPTS		32
#define XTMP_NUM_EXTERNAL_INTERRUPTS	30
