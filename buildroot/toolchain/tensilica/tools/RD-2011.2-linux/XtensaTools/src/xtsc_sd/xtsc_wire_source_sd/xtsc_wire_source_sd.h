#ifndef _XTSC_WIRE_SOURCE_SD_H_
#define _XTSC_WIRE_SOURCE_SD_H_
...
class xtsc_wire_source_sd : public sc_mx_import_module {
public:
  sc_port<xtsc::xtsc_wire_write_if>     m_write;        ///<  TLM port to the wire
  sc_export<xtsc::xtsc_wire_write_if>   m_control;      ///<  Optional 1-bit control input
      
  // constructor / destructor
  xtsc_wire_source_sd(sc_mx_m_base* c, const sc_module_name &module_name);
  virtual ~xtsc_wire_source_sd();
