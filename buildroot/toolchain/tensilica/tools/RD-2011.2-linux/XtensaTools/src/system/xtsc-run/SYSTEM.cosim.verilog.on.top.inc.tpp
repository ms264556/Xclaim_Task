...
;#
;# This file is copied to swtools-{machine}-{os}/src/system/xtsc-run/SYSTEM.cosim.verilog.on.top.inc.tpp
...
--set_tlm2pin_parm=dso_cookie=Testbench.`$key`
...
;   }
;   $memory_index += 1;
--connect_tlm2pin_wrapper=t2p_`$key`,`$key`_
; }
; close(FH);
;#
;#
