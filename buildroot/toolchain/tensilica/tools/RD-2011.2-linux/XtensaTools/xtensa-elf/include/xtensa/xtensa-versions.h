/*
   ...
   $Id: //depot/rel/Cottonwood/Xtensa/Software/misc/xtensa-versions.h.tpp#3 $
...
/*  The current release:  */
#define XTENSA_RELEASE_NAME		"RD-2011.2"
#define XTENSA_RELEASE_CANONICAL_NAME	"RD-2011.2"

/*  The product versions within the current release:  */
#define XTENSA_SWVERSION		XTENSA_SWVERSION_RD_2011_2
#define XTENSA_SWVERSION_NAME		"9.0.2"
#define XTENSA_SWVERSION_CANONICAL_NAME	"9.0.2"
#define XTENSA_SWVERSION_MAJORMID_NAME	"9.0"
#define XTENSA_SWVERSION_MAJOR_NAME	"9"
/*  For product licensing (not necessarily same as *_MAJORMID_NAME):  */
#define XTENSA_SWVERSION_LICENSE_NAME	"9.0"
