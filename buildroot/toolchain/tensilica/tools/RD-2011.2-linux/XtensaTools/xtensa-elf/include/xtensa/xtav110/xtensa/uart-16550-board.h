...
uart-16550-board.h Board-specific UART info on the Avnet AV110 (XT-AV110) board.
...
The XT-AV110 board contains a single 16550 UART implemented on the FPGA.
It's clock frequency comes from the board's core clock (not its own crystal)
...
/* 
The UART's registers are connected at word addresses on the XT-AV110.
