...
extern const char *xtensa_abi_str;
extern const char *xtensa_lspname;
extern const char *xtensa_renamesection;
extern int profile_flag;
extern int pedantic;
...
#define MASK_ABS (1 << 0)
#define MASK_ADDX (1 << 1)
#define MASK_BIG_ENDIAN (1 << 2)
#define MASK_BOOLEANS (1 << 3)
#define MASK_CONST16 (1 << 4)
#define MASK_DENSITY (1 << 5)
#define MASK_DIV32 (1 << 6)
#define MASK_FUSED_MADD (1 << 7)
#define MASK_HARD_DOUBLE (1 << 8)
#define MASK_HARD_DOUBLE_DIV (1 << 9)
#define MASK_HARD_DOUBLE_RECIP (1 << 10)
#define MASK_HARD_DOUBLE_RSQRT (1 << 11)
#define MASK_HARD_DOUBLE_SQRT (1 << 12)
#define MASK_HARD_FLOAT (1 << 13)
#define MASK_HARD_FLOAT_DIV (1 << 14)
#define MASK_HARD_FLOAT_RECIP (1 << 15)
#define MASK_HARD_FLOAT_RSQRT (1 << 16)
#define MASK_HARD_FLOAT_SQRT (1 << 17)
#define MASK_MAC16 (1 << 18)
#define MASK_MINMAX (1 << 19)
#define MASK_MUL16 (1 << 20)
#define MASK_MUL32 (1 << 21)
#define MASK_MUL32_HIGH (1 << 22)
#define MASK_NSA (1 << 23)
#define MASK_SEXT (1 << 24)
#define MASK_ZERO_INIT_DATA (1 << 25)

#define TARGET_ABS ((target_flags & MASK_ABS) != 0)
#define TARGET_ADDX ((target_flags & MASK_ADDX) != 0)
#define TARGET_BIG_ENDIAN ((target_flags & MASK_BIG_ENDIAN) != 0)
#define TARGET_BOOLEANS ((target_flags & MASK_BOOLEANS) != 0)
#define TARGET_CONST16 ((target_flags & MASK_CONST16) != 0)
#define TARGET_DENSITY ((target_flags & MASK_DENSITY) != 0)
#define TARGET_DIV32 ((target_flags & MASK_DIV32) != 0)
#define TARGET_FUSED_MADD ((target_flags & MASK_FUSED_MADD) != 0)
#define TARGET_HARD_DOUBLE ((target_flags & MASK_HARD_DOUBLE) != 0)
#define TARGET_HARD_DOUBLE_DIV ((target_flags & MASK_HARD_DOUBLE_DIV) != 0)
#define TARGET_HARD_DOUBLE_RECIP ((target_flags & MASK_HARD_DOUBLE_RECIP) != 0)
#define TARGET_HARD_DOUBLE_RSQRT ((target_flags & MASK_HARD_DOUBLE_RSQRT) != 0)
#define TARGET_HARD_DOUBLE_SQRT ((target_flags & MASK_HARD_DOUBLE_SQRT) != 0)
#define TARGET_HARD_FLOAT ((target_flags & MASK_HARD_FLOAT) != 0)
#define TARGET_HARD_FLOAT_DIV ((target_flags & MASK_HARD_FLOAT_DIV) != 0)
#define TARGET_HARD_FLOAT_RECIP ((target_flags & MASK_HARD_FLOAT_RECIP) != 0)
#define TARGET_HARD_FLOAT_RSQRT ((target_flags & MASK_HARD_FLOAT_RSQRT) != 0)
#define TARGET_HARD_FLOAT_SQRT ((target_flags & MASK_HARD_FLOAT_SQRT) != 0)
#define TARGET_MAC16 ((target_flags & MASK_MAC16) != 0)
#define TARGET_MINMAX ((target_flags & MASK_MINMAX) != 0)
#define TARGET_MUL16 ((target_flags & MASK_MUL16) != 0)
#define TARGET_MUL32 ((target_flags & MASK_MUL32) != 0)
#define TARGET_MUL32_HIGH ((target_flags & MASK_MUL32_HIGH) != 0)
#define TARGET_NSA ((target_flags & MASK_NSA) != 0)
#define TARGET_SEXT ((target_flags & MASK_SEXT) != 0)
#define TARGET_ZERO_INIT_DATA ((target_flags & MASK_ZERO_INIT_DATA) != 0)

#define TARGET_LITTLE_ENDIAN ((target_flags & MASK_BIG_ENDIAN) == 0)
#define TARGET_SOFT_DOUBLE ((target_flags & MASK_HARD_DOUBLE) == 0)
#define TARGET_SOFT_FLOAT ((target_flags & MASK_HARD_FLOAT) == 0)
...
enum opt_code
{
  ...
  OPT_mbooleans,                             /* -mbooleans */
  OPT_mconst16,                              /* -mconst16 */
  OPT_mdensity,                              /* -mdensity */
  OPT_mdiv32,                                /* -mdiv32 */
  OPT_mfused_madd,                           /* -mfused-madd */
  OPT_mhard_double,                          /* -mhard-double */
  OPT_mhard_double_div,                      /* -mhard-double-div */
  OPT_mhard_double_recip,                    /* -mhard-double-recip */
  OPT_mhard_double_rsqrt,                    /* -mhard-double-rsqrt */
  OPT_mhard_double_sqrt,                     /* -mhard-double-sqrt */
  OPT_mhard_float,                           /* -mhard-float */
  OPT_mhard_float_div,                       /* -mhard-float-div */
  OPT_mhard_float_recip,                     /* -mhard-float-recip */
  OPT_mhard_float_rsqrt,                     /* -mhard-float-rsqrt */
  OPT_mhard_float_sqrt,                      /* -mhard-float-sqrt */
  OPT_mlittle_endian,                        /* -mlittle-endian */
  OPT_mlongcalls,                            /* -mlongcalls */
  OPT_mlsp_,                                 /* -mlsp= */
  OPT_mmac16,                                /* -mmac16 */
  OPT_mminmax,                               /* -mminmax */
  OPT_mmul16,                                /* -mmul16 */
  ...
  OPT_mmul32h,                               /* -mmul32h */
  OPT_mnsa,                                  /* -mnsa */
  OPT_mrename_section_,                      /* -mrename-section- */
  OPT_msext,                                 /* -msext */
  OPT_msoft_double,                          /* -msoft-double */
  OPT_msoft_float,                           /* -msoft-float */
  OPT_mtarget_align,                         /* -mtarget-align */
  OPT_mtext_section_literals,                /* -mtext-section-literals */
  OPT_mzero_init_data,                       /* -mzero-init-data */
