/* 
  Copyright (C) 2004-2009 Tensilica, Inc.  All Rights Reserved.
...
#ifdef _KEEP_RCS_ID
static char *defs_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/defs.h,v $ $Revision: 2.36 $";
#endif /* _KEEP_RCS_ID */
