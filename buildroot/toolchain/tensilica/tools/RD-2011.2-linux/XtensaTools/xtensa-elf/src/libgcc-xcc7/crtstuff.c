...
#define DTOR_LIST_BEGIN \
	STATIC func_ptr __DTOR_LIST__[1] __attribute__ ((section(".dtors"))) \
	  = { (func_ptr) (-1) };
#define DTOR_LIST_DECL \
	static func_ptr __DTOR_LIST__[] __attribute__ ((section(".dtors")))
#define CTOR_LIST_END \
	STATIC func_ptr __CTOR_END__[1] __attribute__ ((section(".ctors"))) \
	  = { (func_ptr) 0 };
#define CTOR_END_DECL \
	static func_ptr __CTOR_END__[] __attribute__ ((section(".ctors"))) 
#define DTOR_LIST_END \
	STATIC func_ptr __DTOR_END__[1] __attribute__ ((section(".dtors"))) \
	  = { (func_ptr) 0 };
#define EH_DESC_BEGIN \
	 char __XT_EXCEPTION_DESCS__[] \
          __attribute__ ((section(".xt_except_desc"))) = { };
#define EH_DESC_END \
	 char __XT_EXCEPTION_DESCS_END__[] \
          __attribute__ ((section(".xt_except_desc_end"))) = { };
#endif /* __XTENSA__ */
...
#ifdef EH_DESC_BEGIN
/* Stick a label at the beginning of the exception descriptors so the
   exception-handling runtime can find it. */
EH_DESC_BEGIN;
#endif /* EH_DESC_BEGIN */
...
#ifdef EH_DESC_END
/* Terminate the exception descriptors. */
EH_DESC_END;
#endif /* EH_DESC_END */
