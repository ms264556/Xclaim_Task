		      ...
		      INT32 flags)
{
  try {
    ...
    if (num_returns > 0)
      pu_handle->Get_Return_Table().reserve_and_init(num_returns);
...
int _profile_toggle = 1;

void xt_feedback_enable (void)
{
  _profile_toggle = 1;
}


void xt_feedback_disable (void)
{
  _profile_toggle = 0;
}
