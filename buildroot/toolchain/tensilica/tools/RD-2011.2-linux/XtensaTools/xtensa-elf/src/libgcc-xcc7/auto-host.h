...
/* early versions of solaris do not have these functions 
   the only change that results is slightly slower io 
*/
...
/* early versions of solaris don't have this function */
#if !defined(__sun__) && !defined(_WIN32)
