...
#ifndef LOG4XTENSA_SPI_FILTER_HEADER_
#define LOG4XTENSA_SPI_FILTER_HEADER_
...
namespace log4xtensa {
    namespace spi {
         ...
         */
        LOG4XTENSA_EXPORT FilterResult checkFilter(const Filter* filter, 
         ...
         *
         * <p>The philosophy of log4xtensa filters is largely inspired from the
         * Linux ipchains. 
         */
        class LOG4XTENSA_EXPORT Filter : public log4xtensa::helpers::SharedObject {
        public:
          // ctor and dtor
            Filter();
            virtual ~Filter();
         ...
         * behaviour.
         */
        class LOG4XTENSA_EXPORT DenyAllFilter : public Filter {
        public:
            /**
         ...
         */
        class LOG4XTENSA_EXPORT LogLevelMatchFilter : public Filter {
        public:
            LogLevelMatchFilter();
            LogLevelMatchFilter(const log4xtensa::helpers::Properties& p);
         ...
         */
        class LOG4XTENSA_EXPORT LogLevelRangeFilter : public Filter {
        public:
          // ctors
            LogLevelRangeFilter();
            LogLevelRangeFilter(const log4xtensa::helpers::Properties& p);
         ...
         * is returned.
         */
        class LOG4XTENSA_EXPORT StringMatchFilter : public Filter {
        public:
          // ctors
            StringMatchFilter();
            StringMatchFilter(const log4xtensa::helpers::Properties& p);
        ...
        private:
          ...
          // Data
            /** Do we return ACCEPT when a match occurs. Default is <code>true</code>. */
            bool acceptOnMatch;
            log4xtensa::tstring stringToMatch;
        };

    } // end namespace spi
} // end namespace log4xtensa

#endif /* LOG4XTENSA_SPI_FILTER_HEADER_ */
