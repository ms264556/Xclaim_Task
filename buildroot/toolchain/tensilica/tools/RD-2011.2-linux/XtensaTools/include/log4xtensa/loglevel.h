...
// 2005.09.01.  Tensilica.  Add NOTE_LOG_LEVEL and VERBOSE_LOG_LEVEL
...
#ifndef LOG4XTENSA_LOGLEVEL_HEADER_
#define LOG4XTENSA_LOGLEVEL_HEADER_
...
namespace log4xtensa {
    ...
    /** \var const LogLevel NOTE_LOG_LEVEL
     * The <code>NOTE_LOG_LEVEL</code> LogLevel designates informational 
     * messages of a one-time nature (e.g. during major component 
     * construction). */
    const LogLevel NOTE_LOG_LEVEL    = 25000;
    ...
    /** \var const LogLevel VERBOSE_LOG_LEVEL
     * The <code>VERBOSE_LOG_LEVEL</code> LogLevel designates informational 
     * messages  that highlight the progress of the application at 
     * fine-grained level. */
    const LogLevel VERBOSE_LOG_LEVEL    = 15000;
     ...
     */
    typedef log4xtensa::tstring (*LogLevelToStringMethod)(LogLevel);
     ...
     */
    typedef LogLevel (*StringToLogLevelMethod)(const log4xtensa::tstring&);
     ...
     * </ol>
     */
    class LOG4XTENSA_EXPORT LogLevelManager {
    public:
        LogLevelManager();
        ~LogLevelManager();
         ...
         */
        log4xtensa::tstring toString(LogLevel ll) const;
        
        /**
         * This method is called by all classes internally to log4xtensa to
         * convert a string into a LogLevel.
         * <p>
         * Note: It traverses the list of <code>StringToLogLevelMethod</code>
         *       to do this, so all "derived" LogLevels are recognized as well.
         */
        LogLevel fromString(const log4xtensa::tstring& s) const;
     ...
     */
    LOG4XTENSA_EXPORT LogLevelManager& getLogLevelManager();

}


#endif // LOG4XTENSA_LOGLEVEL_HEADER_
