...
#ifndef _LOG4XTENSA_SPI_ROOT_LOGGER_HEADER_
#define _LOG4XTENSA_SPI_ROOT_LOGGER_HEADER_

#include <log4xtensa/config.h>
#include <log4xtensa/helpers/loglog.h>
#include <log4xtensa/spi/loggerimpl.h>
...
namespace log4xtensa {
    namespace spi {
         ...
         */
        class LOG4XTENSA_EXPORT RootLogger : public LoggerImpl {
        public:
          // Ctors
            /**
...
#endif // _LOG4XTENSA_SPI_ROOT_LOGGER_HEADER_
