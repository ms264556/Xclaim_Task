...
// 2008.12.05.  Tensilica.  Allow user to determine if log4xtensa has been configured.
// 2005.09.05.  Tensilica.  Use reference for Logger parameter to configureLogger.
...
namespace log4xtensa {
     ...
     */
    class LOG4XTENSA_EXPORT PropertyConfigurator : protected log4xtensa::helpers::LogLogUser
    {
    public:
        // ctor and dtor
        PropertyConfigurator(const log4xtensa::tstring& propertyFile,
                             Hierarchy& h = Logger::getDefaultHierarchy());
        PropertyConfigurator(const log4xtensa::helpers::Properties& props,
                             Hierarchy& h = Logger::getDefaultHierarchy());
        PropertyConfigurator(log4xtensa::tistream& propertyStream,
                             Hierarchy& h = Logger::getDefaultHierarchy());
        virtual ~PropertyConfigurator();

        /**
         * This method eliminates the need to create a temporary
         * <code>PropertyConfigurator</code> to configure log4xtensa.
         ...
         * </code>
         */
        static void doConfigure(const log4xtensa::tstring& configFilename,
                                Hierarchy& h = Logger::getDefaultHierarchy());

        /**
         * Return true if log4xtensa has been configured.
         */
         ...
         * log4xtensa.appender.appenderName=fully.qualified.name.of.appender.class
         *
         * # Set appender specific options.
         * log4xtensa.appender.appenderName.option1=value1
         * ...
         * log4xtensa.appender.appenderName.optionN=valueN
         * </pre>
         *
         * For each named appender you can configure its {@link Layout}. The
         * syntax for configuring an appender's layout is:
         * <pre>
         * log4xtensa.appender.appenderName.layout=fully.qualified.name.of.layout.class
         * log4xtensa.appender.appenderName.layout.option1=value1
         * ....
         * log4xtensa.appender.appenderName.layout.optionN=valueN
         * </pre>
         *
         ...
         * <pre>
         * log4xtensa.rootLogger=[LogLevel], appenderName, appenderName, ...
         * </pre>
         *
         ...
         * <pre>
         * log4xtensa.logger.logger_name=[LogLevel|INHERITED], appenderName, appenderName, ...
         * </pre>
         *
         ...
         * "log4xtensa.disableOverride" to <code>true</code> or any value other
         * than false. As in <pre>log4xtensa.disableOverride=true </pre>
         *
         * <h3>Example</h3>
         *
         ...
         * log4xtensa.appender.A1=log4xtensa::SyslogAppender
         *
         * # The syslog daemon resides on www.abc.net
         * log4xtensa.appender.A1.SyslogHost=www.abc.net
         *
         ...
         * log4xtensa.appender.A1.layout=log4xtensa::PatternLayout
         * log4xtensa.appender.A1.layout.ConversionPattern=%-4r %-5p %c{2} %M.%L %x - %m\n
         *
         * # Set options for appender named "A2"
         * # A2 should be a RollingFileAppender, with maximum file size of 10 MB
         * # using at most one backup file. A2's layout is TTCC, using the
         * # ISO8061 date format with context printing enabled.
         * log4xtensa.appender.A2=log4xtensa::RollingFileAppender
         * log4xtensa.appender.A2.MaxFileSize=10MB
         * log4xtensa.appender.A2.MaxBackupIndex=1
         * log4xtensa.appender.A2.layout=log4xtensa::TTCCLayout
         * log4xtensa.appender.A2.layout.ContextPrinting=enabled
         * log4xtensa.appender.A2.layout.DateFormat=ISO8601
         *
         * # Root logger set to DEBUG using the A2 appender defined above.
         * log4xtensa.rootLogger=DEBUG, A2
         *
         * # Logger definitions:
         * # The SECURITY logger inherits is LogLevel from root. However, it's output
         * # will go to A1 appender defined above. It's additivity is non-cumulative.
         * log4xtensa.logger.SECURITY=INHERIT, A1
         * log4xtensa.additivity.SECURITY=false
         *
         * # Only warnings or above will be logged for the logger "SECURITY.access".
         * # Output will go to A1.
         * log4xtensa.logger.SECURITY.access=WARN
         *
         *
         * # The logger "class.of.the.day" inherits its LogLevel from the
         * # logger hierarchy.  Output will go to the appender's of the root
         * # logger, A2 in this case.
         * log4xtensa.logger.class.of.the.day=INHERIT
         * </pre>
         *
    ...
    protected:
      // Methods
        ...
        void configureLogger(log4xtensa::Logger& logger, const log4xtensa::tstring& config);
        void configureAppenders();
        void configureAdditivity();
        
        virtual Logger& getLogger(const log4xtensa::tstring& name);
        virtual void addAppender(Logger &logger, log4xtensa::SharedAppenderPtr& appender);

      // Types
        typedef std::map<log4xtensa::tstring, log4xtensa::SharedAppenderPtr> AppenderMap;

      // Data
        Hierarchy& h;
        log4xtensa::tstring propertyFilename;
        log4xtensa::helpers::Properties properties; 
     ...
     */
    class LOG4XTENSA_EXPORT BasicConfigurator : public PropertyConfigurator {
    public:
      // ctor and dtor
        ...
        /**
         * This method eliminates the need to create a temporary
         * <code>BasicConfigurator</code> object to configure log4xtensa.
         * It is equivalent to the following:<br>
         * <code>
    ...
    class LOG4XTENSA_EXPORT ConfigureAndWatchThread {
    public:
      // ctor and dtor
        ConfigureAndWatchThread(const log4xtensa::tstring& propertyFile,
    ...
    private:
      ...
      // Data
        log4xtensa::helpers::SharedObjectPtr<ConfigurationWatchDogThread> watchDogThread;
    };
#endif
