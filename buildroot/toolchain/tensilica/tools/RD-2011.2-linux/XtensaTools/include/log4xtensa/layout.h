...
#ifndef _LOG4XTENSA_LAYOUT_HEADER_
#define _LOG4XTENSA_LAYOUT_HEADER_
...
#include <log4xtensa/spi/loggingevent.h>
...
namespace log4xtensa {
     ...
     * #Appender}.
     */
    class LOG4XTENSA_EXPORT Layout : protected :: log4xtensa::helpers::LogLogUser {
    public:
        Layout() : llmCache(getLogLevelManager()) {}
        Layout(const log4xtensa::helpers::Properties&) 
          : llmCache(getLogLevelManager())  {}
        virtual ~Layout() {}

        virtual void formatAndAppend(log4xtensa::tostream& output, 
                                     const log4xtensa::spi::InternalLoggingEvent& event) = 0;
    protected:
     ...
     */
    class LOG4XTENSA_EXPORT SimpleLayout : public Layout {
    public:
        SimpleLayout() {}
        SimpleLayout(const log4xtensa::helpers::Properties& properties) : Layout(properties) {}

        virtual void formatAndAppend(log4xtensa::tostream& output, 
                                     const log4xtensa::spi::InternalLoggingEvent& event);
     ...
     */
    class LOG4XTENSA_EXPORT TTCCLayout : public Layout {
    public:
      // Ctor and dtor
        TTCCLayout(bool use_gmtime = false);
        TTCCLayout(const log4xtensa::helpers::Properties& properties);
        virtual ~TTCCLayout();
     ...
     * that the log4xtensa environment was set to use a PatternLayout. Then the
     * statements
     * <pre>
     * Logger root = Logger.getRoot();
     * LOG4XTENSA_DEBUG(root, "Message 1");
     * LOG4XTENSA_WARN(root, "Message 2");
     * </pre>
     ...
     *   <li>%%q -- milliseconds as decimal(0-999) -- <b>log4xtensa specific</b>
     *   <li>%%Q -- fractional milliseconds as decimal(0-999.999) -- <b>log4xtensa specific</b>
     ...
     */
    class LOG4XTENSA_EXPORT PatternLayout : public Layout {
    public:
      // Ctors and dtor
        PatternLayout(const log4xtensa::tstring& pattern);
        PatternLayout(const log4xtensa::helpers::Properties& properties);
    ...
    protected:
        void init(const log4xtensa::tstring& pattern);

      // Data
        log4xtensa::tstring pattern;
...
#endif // _LOG4XTENSA_LAYOUT_HEADER_
