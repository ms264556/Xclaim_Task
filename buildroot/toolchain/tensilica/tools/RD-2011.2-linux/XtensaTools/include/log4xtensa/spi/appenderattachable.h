...
#ifndef _LOG4XTENSA_SPI_APPENDER_ATTACHABLE_HEADER_
#define _LOG4XTENSA_SPI_APPENDER_ATTACHABLE_HEADER_
...
namespace log4xtensa {
    ...
    typedef std::vector<log4xtensa::SharedAppenderPtr> SharedAppenderPtrList;
    ...
    namespace spi {
         ...
         */
        class LOG4XTENSA_EXPORT AppenderAttachable {
        public:
          // Methods
            /**
             * Add an appender.
             ...
             */
            virtual SharedAppenderPtr getAppender(const log4xtensa::tstring& name) = 0;
             ...
             * list of appenders.  
             */
            virtual void removeAppender(const log4xtensa::tstring& name) = 0;
...
#endif // _LOG4XTENSA_SPI_APPENDER_ATTACHABLE_HEADER_
