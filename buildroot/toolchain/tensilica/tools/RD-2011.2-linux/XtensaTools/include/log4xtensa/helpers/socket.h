...
#ifndef LOG4XTENSA_HELPERS_SOCKET_HEADER_
#define LOG4XTENSA_HELPERS_SOCKET_HEADER_

#include <log4xtensa/config.h>
#include <log4xtensa/tstring.h>
#include <log4xtensa/helpers/socketbuffer.h>
#if defined(_WIN32)
#include <winsock.h>
#endif
...
#define INVALID_SOCKET -1
        ...
        class LOG4XTENSA_EXPORT AbstractSocket {
        public:
          // ctor and dtor
            AbstractSocket();
         ...
         */
        class LOG4XTENSA_EXPORT Socket : public AbstractSocket {
        public:
          // ctor and dtor
            Socket();
         ...
         * requester.
         */
        class LOG4XTENSA_EXPORT ServerSocket : public AbstractSocket {
        public:
          // ctor and dtor
        ...
        LOG4XTENSA_EXPORT SOCKET_TYPE openSocket(unsigned short port, SocketState& state);
        LOG4XTENSA_EXPORT SOCKET_TYPE connectSocket(const log4xtensa::tstring& hostn,
                                                   unsigned short port, SocketState& state);
        LOG4XTENSA_EXPORT SOCKET_TYPE acceptSocket(SOCKET_TYPE sock, SocketState& state);
        LOG4XTENSA_EXPORT int closeSocket(SOCKET_TYPE sock);

        LOG4XTENSA_EXPORT size_t read(SOCKET_TYPE sock, SocketBuffer& buffer);
        LOG4XTENSA_EXPORT size_t write(SOCKET_TYPE sock, const SocketBuffer& buffer);
