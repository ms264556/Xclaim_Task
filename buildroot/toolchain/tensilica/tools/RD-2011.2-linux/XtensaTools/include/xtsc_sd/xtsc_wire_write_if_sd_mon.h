#ifndef _XTSC_WIRE_WRITE_IF_SD_MON_H_
#define _XTSC_WIRE_WRITE_IF_SD_MON_H_
...
class XTSC_SD_API xtsc_wire_write_if_sd_mon : public sc_mx_import_module, public MxDIBase {
public:
  sc_export<xtsc::xtsc_wire_write_if>            m_wire_write_export;
  sc_port<xtsc::xtsc_wire_write_if>              m_wire_write_port;
      
  SC_HAS_PROCESS(xtsc_wire_write_if_sd_mon);

  // constructor / destructor
  xtsc_wire_write_if_sd_mon(sc_mx_m_base* c, const sc_module_name &module_name);
  virtual ~xtsc_wire_write_if_sd_mon();
...
protected:
  ...
  class xtsc_wire_write_if_impl : public xtsc::xtsc_wire_write_if, public sc_object {
  public:

    /// Constructor
    xtsc_wire_write_if_impl(const char *object_name, xtsc_wire_write_if_sd_mon& monitor) :
  ...
  protected:
    ...
    xtsc_wire_write_if_sd_mon&  m_monitor;      ///< Our xtsc_wire_write_if_sd_mon object
...
private:
  ...
  xtsc::u64                             m_num_nb_write;                 ///< Total calls to nb_write 

  sc_unsigned                          *m_p_value;                    ///< Last wire value written
...
#endif  // _XTSC_WIRE_WRITE_IF_SD_MON_H_
