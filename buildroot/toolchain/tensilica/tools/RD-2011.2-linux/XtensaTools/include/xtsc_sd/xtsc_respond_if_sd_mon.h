#ifndef _XTSC_RESPOND_IF_SD_MON_H_
#define _XTSC_RESPOND_IF_SD_MON_H_
...
class XTSC_SD_API xtsc_respond_if_sd_mon : public sc_mx_import_module, public MxDIBase, public MxPI {
public:
  sc_export<xtsc::xtsc_respond_if>      m_respond_export;
  sc_port<xtsc::xtsc_respond_if>        m_respond_port;
      
  // constructor / destructor
  xtsc_respond_if_sd_mon(sc_mx_m_base* c, const sc_module_name &module_name);
  virtual ~xtsc_respond_if_sd_mon();
...
protected:
  ...
  public:
    ...
    /// Constructor
    xtsc_respond_if_impl(const char *object_name, xtsc_respond_if_sd_mon& monitor) :
  ...
  protected:
    ...
    xtsc_respond_if_sd_mon&     m_monitor;      ///< Our xtsc_respond_if_sd_mon object
...
private:
  ...
  xtsc::u64                             m_num_responses;                ///< Total responses
  xtsc::xtsc_address                    m_address8;                     ///< Byte address 
  xtsc::u32                             m_size8;                        ///< Byte size of each transfer (artificial)
  xtsc::u8                              m_buffer[xtsc::xtsc_max_bus_width8];  ///< Data for READ, BLOCK_READ, and RCW
  xtsc::u32                             m_route_id;                     ///< Route ID for arbiters
  xtsc::xtsc_response::status_t         m_status;                       ///< Response status
  ...
  bool                                  m_return;                       ///< The value returned from the nb_respond() call

  // MxPI
  MxPIStreamInfo_t                      m_response_stream_info;         ///< MxPI stream info
  MxPIStream_t                         *m_p_response_stream;
  MxPIChannel_t                        *m_response_channel_ptr_tab[2];
  MxPIChannelSymbolInfo_t               m_response_status_symbols;      ///< xtsc_response::status_t symbols
  MxPIChannel_t                         m_response_status_channel;
  MxPIChannel_t                         m_response_size_channel;
...
#endif  // _XTSC_RESPOND_IF_SD_MON_H_
